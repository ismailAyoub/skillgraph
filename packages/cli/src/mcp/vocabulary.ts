/**
 * Node/edge vocabulary and GraphPatch reference, served by the `graph_vocabulary` tool, the
 * `skillgraph://vocabulary` resource and compiled into the `skillgraph-authoring` meta-skill as
 * `references/vocabulary.md`. Derived from docs/graph-spec.md sections 3-5 and 16.
 */
export const VOCABULARY_MD = `# SkillGraph vocabulary
